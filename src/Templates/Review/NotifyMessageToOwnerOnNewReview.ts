export const NotifyMessageToOwnerOnNewReview = `
<!DOCTYPE html>
...
<h1 style="margin: 0; color: #072b52; direction: ltr; font-family: 'Lora', Georgia, serif; font-size: 50px; font-weight: normal; letter-spacing: 1px; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 60px;"><strong>You got a new Review.</strong></h1>
</td>
</tr>
</table>
</td>
...
<p style="margin: 0; word-break: break-word;"><span>You have just gotten a new Review on <strong> {{propertyName}} </strong> on <strong> {{date}} </strong></span></p>
